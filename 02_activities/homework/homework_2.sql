...
SELECT product_id, 
product_name, 
CASE WHEN product_qty_type IN ("lbs","oz") THEN "unit"
...
-- Option 1 - If common columns like vendor_id can be repeated in the results
SELECT v.*, vba.*
FROM vendor v
...
-- Option 2 - If common columns like vendor_id should not be repeated in the results
